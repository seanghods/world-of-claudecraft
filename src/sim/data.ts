...
const BG_Z0 = -1500;
const BG_SLOT_SPACING = 460; // > the 124x304 document rect (the walled
// 100x280 classic field plus its backdrop ring), with enough margin that
// cross-slot player pairs (over 150yd apart at the seam, both walled in) stay
// beyond the OPEN-WORLD interest radius; the RAISED in-band radius applies
// to SAME-slot pairs only (server/game.ts BG_MATCH_DROP_RADIUS)
